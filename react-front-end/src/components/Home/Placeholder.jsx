  ...
  return (
    ...
    <div class="center">
      ...
      <div className="placeholder">
        <h1>Kintsugi</h1>
        <p>
          Kintsugi is an app built to help connect you with the mental health care that you need. <p />
          Our interface is designed to help you find a professional in your area that can speak your language and
          understand your cultural background. <p />
